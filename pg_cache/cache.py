...
class CacheEntry(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_partition_key', 'partition_key'),  # 为分区键创建索引
    )
...
class AsyncPgCache:
    ...
    async def set(self, key: str, value: Any, expire_after_seconds: int = 86400,
                  partition_key: str = 'default') -> None:
    ...
    async def get(self, key: str, partition_key: str = 'default') -> Optional[Any]:
    ...
    async def delete(self, key: str, partition_key: str = 'default') -> None:
    ...
    async def delete_bulk(self, keys: List[str], partition_key: str = 'default') -> None:
    ...
    async def flushdb(self, partition_key: str = 'default') -> None:
    ...
    async def export_to_file(self, file_path: str, partition_key: str = 'default') -> None:
    ...
    async def import_from_file(self, file_path: str, partition_key: str = 'default') -> None:
